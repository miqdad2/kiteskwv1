                  ...
                  {t.approach.steps.map((step, index) => (
                    <StaggerItem key={index} index={index}>
                      <div className="flex flex-col items-center text-center group relative z-10">
                        ...
                        <p className="font-body text-[13px] text-muted-foreground leading-relaxed max-w-[170px] mx-auto opacity-80">
                          {step.desc}
                        </p>
                      </div>
                    </StaggerItem>
          ...
          <section className="py-28 lg:py-36 bg-gradient-to-b from-secondary/15 to-background border-y border-border/50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <ScrollReveal className="text-center max-w-2xl mx-auto">
                <p className="font-body text-base sm:text-lg text-muted-foreground/80 mb-10 leading-relaxed italic">
                  {t.cta.bridge.text}
                </p>
                <Link
                  to="/contact"
