        ...
        <section ref={sectionRef} id="key-pillars" className="py-20 lg:py-28 bg-white relative overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="pillar-header text-center mb-20 opacity-0">
                    <p className="font-body text-caption font-medium text-[#60a5fa]/80 uppercase tracking-[0.2em] mb-4">
                        {t.pillarsLabel}
                    </p>
                    <div className="h-px w-12 bg-[#60a5fa] mx-auto" />
                </div>
                ...
                <div className="pillar-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {t.pillars.map((pillar, index) => (
                        <div key={pillar.title} className="pillar-card opacity-0">
                            <div className="group h-full p-8 bg-white border border-gray-100 border-t-2 border-t-transparent rounded-xl transition-all duration-300 ease-executive shadow-sm hover:shadow-xl hover:border-gray-200 hover:border-t-[#60a5fa] hover:-translate-y-1 text-center flex flex-col items-center">
                                <div className="w-16 h-16 bg-gray-50 border border-gray-100 rounded-full flex items-center justify-center mb-8 group-hover:bg-[#60a5fa]/5 group-hover:border-[#60a5fa]/10 group-hover:scale-105 transition-all duration-300 ease-executive">
                                    <pillar.icon className="text-gray-400 group-hover:text-[#60a5fa] transition-colors duration-300 ease-executive" size={28} strokeWidth={1.25} />
                                </div>
