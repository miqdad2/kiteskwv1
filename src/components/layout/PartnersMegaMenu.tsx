                ...
                <div className="grid grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div className="col-span-3 flex flex-col space-y-0.5">
                            ...
                            >
                                <div className="flex items-center gap-2.5">
                                    <cat.icon
                                        ...
                                        className={cn(
                                            activeCategory === cat.id ? "text-white" : "text-slate-400 group-hover:text-[#0052CC]"
                                        )}
                                        strokeWidth={1.5}
                                    />
                        ...
                        <Link
                            to="/partners"
                            onClick={onClose}
                            className="mt-4 px-3 text-xs font-semibold text-[#0052CC] hover:text-[#003d99] flex items-center"
                        >
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="grid grid-cols-5 gap-3 animate-in fade-in duration-200" key={activeCategory}>
                                {activePartners.map((partner) => (
                                    <div key={partner.id} className="group relative bg-white p-3 rounded-sm border border-gray-200/80 hover:border-[#0052CC]/40 transition-colors duration-150 flex items-center justify-center aspect-[4/3]">
                                        <img
                                            src={partner.logo}
                                            alt={partner.name}
